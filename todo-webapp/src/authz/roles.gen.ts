...
export const SCOPES: readonly Scope[] = ["todo-entries:create", "todo-entries:delete", "todo-entries:read", "todo-entries:update"];
...
export const ROLE_GRANTS: Record<Role, readonly Scope[]> = {
  "User": ["todo-entries:create", "todo-entries:delete", "todo-entries:read", "todo-entries:update"],
};
